<template>
  <section class="v-property-listing-page-view py-12 lg:py-16">
...
import VPropertyListingFilters from './VPropertyListingFilters.vue';
import VPropertyListingList from './VPropertyListingList.vue';
