<template>
  ...
  >
    <a
      :href="link"
      class="property-card__item group flex h-full w-full overflow-hidden rounded-2xl bg-card shadow-md transition-all duration-300 hover:border-primary/30 hover:shadow-xl"
    >
      ...
      <div class="flex grow flex-col p-6">
        ...
        <div class="mt-4 flex flex-wrap items-center gap-4 pb-6 text-sm text-foreground/70">
          ...
          <p class="property-card__short-description line-clamp-2">{{ property.shortDescription }}</p>
        </div>
...
import VueImage from '../image/VueImage.vue';
