<template>
  <div class="v-property-detail-slider py-8 lg:py-10">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div
        ref="swiper"
        id="main-slider"
        class="v-property-detail-slider__main swiper w-full overflow-hidden rounded-2xl bg-secondary"
      >
        ...
        <button
          class="v-property-detail-slider__main-prev absolute left-4 top-1/2 z-10 hidden h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-card/80 backdrop-blur-sm transition-colors hover:bg-card lg:flex"
          type="button"
        ...
        <button
          class="v-property-detail-slider__main-next absolute right-4 top-1/2 z-10 hidden h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-card/80 backdrop-blur-sm transition-colors hover:bg-card lg:flex"
          type="button"
      ...
      <div
        ref="thumbs"
        id="thumb-slider"
        class="v-property-detail-slider__thumb swiper"
      >
        <div class="swiper-wrapper">
          <div
            v-for="(image, i) in images"
...
let thumbsInstance: null | SwiperInstance = null;
...
async function initSwiper() {
  ...
  sliderInstance = new Swiper(swiperRef.value, {
    ...
    navigation: {
      prevEl: '.v-property-detail-slider__main-prev',
      nextEl: '.v-property-detail-slider__main-next',
    },
    on: {
      slideChange(swiper) {
